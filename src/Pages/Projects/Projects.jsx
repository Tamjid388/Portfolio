...
export const Projects = () => {
  ...
  return (
    <div className="container mx-auto py-10  ">
      ...
      md:grid-cols-2 md:gap-y-6 lg:grid-cols-3  gap-6 gap-y-2  px-2">
            ...
            <div key={index}>
             ...
             border-none bg-black  shadow-[0_0_0_0.5px_rgba(255,255,255,0.6)]
               ">
                ...
                <CardContent>
                  <CardTitle className="text-2xl md:text-nowrap text-white mb-1">{card.name}</CardTitle>
                ...
                <CardFooter className="grid md:grid-cols-2 md:items-start gap-2">
                  ...
                  {card?.collaboration && (
                    <Button variant="outline"
                      className="bg-white/20 text-white font-semibold text-sm flex items-center gap-1">
                ...
                <CardFooter className="space-x-4">
                  <Button className="" variant="outline">
                    <Link to={card.liveLink} target="_blank"
                      rel="noopener noreferrer">Live Link</Link>
                  </Button>


                  <Button variant="secondary">

                    <Link to={card.githubRepo} target="_blank"
                      rel="noopener noreferrer"> <FaGithub></FaGithub> </Link>
                  </Button>
